...
@dp.message_handler(IsAdmin(), commands='close', is_chat_admin=True, chat_type=[types.ChatType.GROUP, types.ChatType.SUPERGROUP])
...
@dp.message_handler(IsAdmin(), commands='open', is_chat_admin=True, chat_type=[types.ChatType.GROUP, types.ChatType.SUPERGROUP])
