...
@dp.message_handler(commands=['check'], is_reply=True, chat_type=[types.ChatType.GROUP, types.ChatType.SUPERGROUP])
...
@dp.message_handler(commands=['check'], chat_type=[types.ChatType.GROUP, types.ChatType.SUPERGROUP])
